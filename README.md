...
| 5. Create FileStorage class | [/models/engine/file_storage.py](/models/engine/file_storage.py) [/models/_ _init_ _.py](/models/_ _init_ _.py) [/models/base_model.py](/models/base_model.py) | Defines a class to manage persistent file storage system|
